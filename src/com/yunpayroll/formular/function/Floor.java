...
public class Floor extends Function{
    ...
    protected void checkNumOfArgs() throws ParseException {
		if(getNumOfArgs()!=1) {
	    	throw new ParseException("function Floor must be have 1 args");
	    }	    
    }
    ...
    protected void operator(Stack<Object> stack) throws ParseException {
		...
		if( !(p1 instanceof BigDecimal) ) {
			throw new ParseException("function floor's args must be a number type");
		}
		BigDecimal arg = (BigDecimal)p1;
		stack.push(BigDecimal.valueOf(Math.floor(arg.doubleValue())));
